//! Plugin: BigPlotDemoActivity
//!
//! Stateful — host must call big_plot.initState()/deinitState().

const std = @import("std");
const MeshulaLab = @import("MeshulaLab");
const activities = @import("demo_activities");
const activity_mod = activities.big_plot;

const PLUGIN_NAME = "BigPlotDemoPlugin";
const PLUGIN_VERSION = "1.0.0";
const PROVENANCE = "ZIIS Demo";
const ACTIVITY_NAME: [*c]const u8 = "BigPlotDemoActivity";
