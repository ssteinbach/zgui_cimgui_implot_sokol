//! Plugin: TextureDemoActivity
//!
//! Stateful — host must call texture.initState(). Has per-frame Update.
...
const PLUGIN_NAME = "TextureDemoPlugin";
const PLUGIN_VERSION = "1.0.0";
const PROVENANCE = "ZIIS Demo";
const ACTIVITY_NAME: [*c]const u8 = "TextureDemoActivity";
