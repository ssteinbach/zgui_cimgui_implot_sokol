//! Plugin: UndoJournalDemoActivity
//!
//! Stateful — host must call undo_journal.initState()/deinitState().

const std = @import("std");
const MeshulaLab = @import("MeshulaLab");
const ziis = @import("zgui_cimgui_implot_sokol");
const activities = @import("demo_activities");
const activity_mod = activities.undo_journal;

const PLUGIN_NAME = "UndoJournalDemoPlugin";
const PLUGIN_VERSION = "1.0.0";
const PROVENANCE = "ZIIS Demo";
const ACTIVITY_NAME: [*c]const u8 = "UndoJournalDemoActivity";
...
{
    activity_mod.initState(std.heap.c_allocator, 5);
}
