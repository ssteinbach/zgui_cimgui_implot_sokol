//! Plugin: CanvasDrawingDemoActivity

const std = @import("std");
const MeshulaLab = @import("MeshulaLab");
const activities = @import("demo_activities");
const activity_mod = activities.canvas;

const PLUGIN_NAME = "CanvasDrawingDemoPlugin";
const PLUGIN_VERSION = "1.0.0";
const PROVENANCE = "ZIIS Demo";
const ACTIVITY_NAME: [*c]const u8 = "CanvasDrawingDemoActivity";
