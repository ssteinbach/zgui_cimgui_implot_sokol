//! Plugin: InfLinesPieChartDemoActivity

const std = @import("std");
const MeshulaLab = @import("MeshulaLab");
const ziis = @import("zgui_cimgui_implot_sokol");
const activities = @import("demo_activities");
const activity_mod = activities.inflines_pie;

const PLUGIN_NAME = "InfLinesPieChartDemoPlugin";
const PLUGIN_VERSION = "1.0.0";
const PROVENANCE = "ZIIS Demo";
const ACTIVITY_NAME: [*c]const u8 = "InfLinesPieChartDemoActivity";
